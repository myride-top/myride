...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for MyRide - The ultimate platform for car enthusiasts',
}
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <div className="space-y-6 text-muted-foreground">
          <section>
            ...
            <p>
              By accessing and using MyRide ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. 
          ...
          <section>
            ...
            <p>
              MyRide is a platform that allows car enthusiasts to showcase their vehicles, share photos, 
              connect with other automotive enthusiasts, and browse car collections from around the world.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You retain ownership of content you submit to the Service. By submitting content, you grant MyRide a worldwide, 
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">6. Car Information Accuracy</h2>
            <p>
              While we encourage accurate information, MyRide does not verify the accuracy of car specifications, 
              photos, or other details posted by users. Users are responsible for the accuracy of their own content.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              THE SERVICE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND. MYRIDE DISCLAIMS ALL WARRANTIES, 
          ...
          <section>
            ...
            <p>
              IN NO EVENT SHALL MYRIDE BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, 
          ...
          <section>
            ...
            <p>
              ...
              in which MyRide operates, without regard to its conflict of law provisions.
            </p>
          </section>
