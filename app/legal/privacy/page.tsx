...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for MyRide - Learn how we protect your personal information',
}
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <div className="space-y-6 text-muted-foreground">
          <section>
            ...
            <p>
              At MyRide, we are committed to protecting your privacy and ensuring the security of your personal information. 
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li><strong>Public Content:</strong> Car information and photos you choose to share are visible to other users</li>
          ...
          <section>
            ...
            <p>
              ...
              unauthorized access, alteration, disclosure, or destruction. Your data is stored securely using industry-standard 
