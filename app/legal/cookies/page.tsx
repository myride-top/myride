      ...
      <div className='prose prose-gray dark:prose-invert max-w-none'>
        ...
        <div className='space-y-6 text-muted-foreground'>
          ...
          <section>
            ...
            <p>
              At MyRide, we use cookies and similar technologies to enhance your
              experience, analyze how our platform is used, and provide
              personalized content. Cookies help us understand how you interact
              with our service and allow us to improve it continuously.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              areas, and form submissions. The website cannot function properly
            ...
            <p>
              ...
              get error messages. This information is used to improve how our
              website works.
            </p>
            <ul className='list-disc pl-6 mt-2 space-y-1'>
            ...
            <p>
              ...
              provide enhanced, more personal features. They may also be used to
            ...
            <p>
              ...
              pages. We use these services to enhance functionality and analyze
              usage patterns.
            </p>
            <ul className='list-disc pl-6 mt-2 space-y-1'>
              ...
              <table className='w-full border-collapse border border-border'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='border border-border px-4 py-2'>
                      Stores user&apos;s theme preference (light/dark)
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='border border-border px-4 py-2'>
                      Stores user&apos;s preferred unit system (metric/imperial)
                    </td>
                    <td className='border border-border px-4 py-2'>1 year</td>
                  </tr>
                  <tr>
          ...
          <section>
            ...
            <p>
              For third-party cookies, you can opt out through the respective
              service providers:
            </p>
            <ul className='list-disc pl-6 mt-2 space-y-1'>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              affect the functionality of our website. Some features may not
              work properly, and your experience may be less personalized.
            </p>
            <p className='mt-2'>
