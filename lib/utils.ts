...
export function convertToMetric(value: number | null | undefined, type: keyof typeof unitConversions): string {
  if (value === null || value === undefined) return ''
...
export function getUnitLabel(type: keyof typeof unitConversions, unitPreference: 'metric' | 'imperial' = 'metric'): string {
  if (unitPreference === 'metric') {
